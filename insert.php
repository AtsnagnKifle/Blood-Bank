...
<?php
        ...
        $_SESSION['drinsert']="";
            ...
            <h2>Insert Into Bank</h2>
            <br>
            <h4 style="color:green;">Already have an account</h4>
            <form action="loged/doctor/insert.php" method="POST">
                <div class="form-group" >
                    <lable for="username">User Name</lable>
                    <input type="text" name="username" id="username" placeholder="User Name" class="form-control">
                </div>
                <span style="color:red">'.$_SESSION['insertusernameerror'].'</span>

                <br><button name="submit" type="submit" class="btn btn-info">Insert</button>
            </form>
            </div>
            '
            .'<hr><hr>';
        ...
        echo '<div class="container-fluid" style="margin:auto;width:60%;">
            <form action="back/donorsignup.php" method="POST">
                ...
                ';
                 echo '<button class="btn btn-info" type="submit" name="submit">Register And Insert</button>';  
                echo '</form></div>';
