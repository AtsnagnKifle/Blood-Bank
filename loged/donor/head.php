        ...
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse" id="navbarcollapse">
                <ul class="nav navbar-nav">
					...
					<li><a href="list.php" style="font-size:20px;">Accepter List</a></li>
					<li><a href="make.php" style="font-size:20px;">Make Donation</a></li>
                    <li><a href="bank.php" style="font-size:20px;">Bank</a></li>
				</ul> 
				<div class="navbar-right">
                    <form action="back/logout.php" method="POST">
                       <span class='btn btn-sm btn-danger'> Donor </span>
