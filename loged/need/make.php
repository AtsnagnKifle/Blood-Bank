<?php
        ...
        if(isset($_SESSION['now']) && $_SESSION['now']!=false){
            ...
            <p>well done you have been added successfully to the accepters list</p>
            <hr>
       ...
       <div class='container-fluid' style='width:60%;margin:auto;'>
        ...
        <div>
            <h2>Do You Want To Delete Request</h2>
            <form action='back/delete.php' method='POST'><button class='btn btn-danger' name='submit' type='submit' id='submit'>Delete</button></form>
        </div>
       </div>";
    }
    else{
        ...
        <div class='container-fluid' style='margin:auto;width:60%;'>
                ...
                <h4>Full Name : ". $_SESSION['firstname']." ".$_SESSION['midlename']."</h4>"
                ...
                <br><br>
            <form action='back/makerequest.php' method='POST'>
                <div class='form-group'>
                    <h4>Describe Your Situation Here</h4>
                    <textarea name='description' id='description' class='form-control'></textarea>
                </div>
                <button class='btn btn-info' name='submit' type='submit'>Make Request</button>
            </form>
